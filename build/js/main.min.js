...
/*!*************************!*\
  !*** ./js/accordion.js ***!
  \*************************/
/*! exports provided: getAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAccordion", function() { return getAccordion; });
var accordionItem = document.querySelectorAll('.accordion-item');
var accordionHeader = document.querySelectorAll('.accordion-item__header');

var getAccordion = function getAccordion() {
  ...
  accordionHeader.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      if (parent.classList.contains('accordion-item__current')) {
        ...
        accordionItem.forEach(function (child) {
          return child.classList.remove('accordion-item__current');
        });
...
var companyInfo = document.querySelector('.company__info');
...
/* harmony import */ var _company__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./company */ "./js/company.js");
/* harmony import */ var _mask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mask */ "./js/mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])(); // initModals();
});
window.addEventListener('load', function () {
  Object(_popup__WEBPACK_IMPORTED_MODULE_4__["onModal"])();
  Object(_mask__WEBPACK_IMPORTED_MODULE_3__["getMask"])();
  ...
  try {
    var _loop = function _loop() {
      ...
      anchor.addEventListener('click', function (evt) {
        evt.preventDefault();
        Object(_popup__WEBPACK_IMPORTED_MODULE_4__["getscroll"])();
  ...
  Object(_company__WEBPACK_IMPORTED_MODULE_2__["onClick"])();
  Object(_accordion__WEBPACK_IMPORTED_MODULE_1__["getAccordion"])();
}); // ---------------------------------
...
var getMask = function getMask() {
  ...
  Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(inputTel, {
    mask: '+{7}(000)000-00-00'
  });
  Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(inputTelModal, {
    mask: '+{7}(000)000-00-00'
  });
  ...
  inputTelModal.addEventListener('input', function () {
...
/*!*********************!*\
  !*** ./js/popup.js ***!
  \*********************/
/*! exports provided: getscroll, onModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getscroll", function() { return getscroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onModal", function() { return onModal; });
...
var firstInput = document.querySelector('.modal__input');
var main = document.querySelector('main');
var header = document.querySelector('header');
var footer = document.querySelector('footer');
var focusableElsMain = main.querySelectorAll(SELECTORS);
var focusableElsHead = header.querySelectorAll(SELECTORS);
var focusableElsFoot = footer.querySelectorAll(SELECTORS);
...
var onModal = function onModal() {
  ...
  var openPopup = function openPopup(evt) {
    evt.preventDefault();
    ...
    focusableElsHead.forEach(function (el) {
      return el.setAttribute('tabindex', '-1');
    });
    header.setAttribute('aria-hidden', 'true');
    focusableElsMain.forEach(function (el) {
      return el.setAttribute('tabindex', '-1');
    });
    main.setAttribute('aria-hidden', 'true');
    focusableElsFoot.forEach(function (el) {
      return el.setAttribute('tabindex', '-1');
    });
